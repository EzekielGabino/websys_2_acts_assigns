...
<div class="products-page">
    ...
    <div class="products-sidebar">
        ...
        <a href="{{ route('discounts') }}"
           class="cat-item {{ request()->routeIs('admin.discount') ? 'active' : '' }}">
            <i class="bi bi-cup-straw"></i> 20% off Discounts
        </a>
    </div>
            ...
            <form action="{{ route('orders.store') }}" method="POST">
                ...
                @foreach($orders as $order)
                    ...
                    <div class="order-item">
                        ...
                        @if ( $order['product_cat'] == 'Discounts')
                            <div class="order-row"><span>Original Price</span><span>₱{{ number_format($order['price'], 2) / 0.80 }}</span></div>
                        @endif
                        <div class="order-row"><span>{{ $order['product_cat'] == 'Discounts' ? 'Discounted': '' }} Price</span><span>₱{{ number_format($order['price'], 2) }}</span></div>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="category" class="form-select">
                            ...
                            <option value="Discounts"      {{ old('category')=='Discounts'  ? 'selected' : '' }}>Discount</option>
                        </select>
